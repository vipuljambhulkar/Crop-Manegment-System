...
<body><div class="footer-distributed" id="aboutUs">
    <center>
        <h1 style="font: 55px calibri; color: rgb(238, 62, 31);">About Us</h1>
    </center>
    <center>
    <div class="footer-left">
        <h3 style="font-family: 'Times New Roman', cursive; font-size:30px; color:white">Crop Management System &copy; </h3>
		...
		<div class="footer-center">
			<div>
				...
				<div style="font-size:20px; color: white;">Vipul Jambhulkar</div>
                <div>
                    <!-- <i class="fa fa-envelope"></i> -->
                    <p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:black">vipuljhambhulkar@gmail.com</a></p>
                    </a></p>

                </div>
                <div style="font-size:20px; color: white;">Priyanka Gaikwad</div>
                
                    <!-- <i class="fa fa-envelope"></i> -->
                    <p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:black">gaikwadpriyanka208@gmail.com</a></p>
                
                
                <div style="font-size:20px; color: white;" >Ashwini Pathare</div>
                <div>
                    <!-- <i class="fa fa-envelope"></i> -->
                    <p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:black">ashwinipathare2016@gmail.com</a></p>
                </div>
                
                <div style="font-size:20px; color: white;">Shreya Tambe</div>
                <div>
                    <!-- <i class="fa fa-envelope"></i> -->
                    <p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:black">shreyatambe5@gmail.com</a></p>
                </div>
			</div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Crop Management system</b></span>
				 is e-commerce trading platform for Crops & fertilizers...
			</p>
