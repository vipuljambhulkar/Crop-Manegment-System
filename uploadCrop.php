<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
		...
		$sql = "INSERT INTO  `cproduct` (`fid`,  `product`, `pcat`, `pinfo`, `price`)
		...
		if(in_array($picActualExt, $allowed))
		{
			if($picError === 0)
			{
				...
				$sql = "UPDATE cproduct SET picStatus=1, pimage='$picNameNew' WHERE product='$productName';";
	...
	<body>
		...
		<!-- One -->
			...
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<form method="POST" action="uploadCrop.php" enctype="multipart/form-data">
					  ...
					  <div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto" >
							  <select name="type" id="type" required style="background-color:white;color: black;">
								  ...
								  <!-- <option value="organic" style="color: black;">organic</option> -->
								  </select>
						</div>
					  </div>
					  <br>
				...
				<br>
				<div>
				<textarea  name="pinfo" id="pinfo" rows="5" style="border: 2px solid white;"></textarea>
				</div>
			<br>
			<div class="row">
				<div class="col-sm-6">
				...
				<br>
				<div class="col-sm-6">
					<button class="button fit" style="width:auto; color:black;  border: 1px solid white">Submit</button>
				</div>
			</div>
			</form>
		</div>
