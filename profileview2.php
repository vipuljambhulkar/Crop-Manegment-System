                            ...
                            <center>
                                <div class="row uniform">
                                    <div class="3u 12u$(large)">
                                        <a href="ch.php" class="btn btn-danger" style="text-decoration: none;">Change Password</a>
                                    </div>
                                    <!-- <div class="3u 12u$(large)">
                                        <a href="profileEdit.php" class="btn btn-danger" style="text-decoration: none;">Edit Profile</a>
                                    </div> -->
                                    <div class="3u 12u$(xsmall)">
            							<a href="uploadProduct.php" class="btn btn-danger" style="text-decoration: none;">Upload Fertilizer</a>
            						</div>
                                    <div class="3u 12u$(xsmall)">
            							<a href="uploadCrop.php" class="btn btn-danger" style="text-decoration: none;">Upload Crop</a>
            						</div>
                                    <div class="3u 12u$(large)">
