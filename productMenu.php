		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="Inorganic" style="color: black;">Inorganic</option>
									</select>
							  	</div>
							</div>
							<div class="col-sm-2">
				...
				<?php
					...
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'organic'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "Inorganic")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'Inorganic'";
					}
