		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
				...
				<?php
					...
					{
					 	$sql = "SELECT * FROM cproduct WHERE 1";
					}
				    if(isset($_GET['type']) AND $_GET['type'] == "fruit")
					{
						$sql = "SELECT * FROM cproduct WHERE pcat = 'Fruit'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "vegetable")
					{
						$sql = "SELECT * FROM cproduct WHERE pcat = 'Vegetable'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "grain")
					{
						$sql = "SELECT * FROM cproduct WHERE pcat = 'Grains'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "organic")
					{
						$sql = "SELECT * FROM cproduct WHERE pcat = 'organic'";
					}
					...
					<?php
						...
						?>
							...
							<a href="cropreview.php?pid=<?php echo $row['pid'] ;?>" > <img class="image fit" src="<?php echo $picDestination;?>" height="220px;"  /></a>
